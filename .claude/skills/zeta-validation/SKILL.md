---
name: zeta-validation
description: Create validation rules and tests for the Judo Zeta Validation Framework using annotations like @Constraint, @Critique, @Satisfies
---
