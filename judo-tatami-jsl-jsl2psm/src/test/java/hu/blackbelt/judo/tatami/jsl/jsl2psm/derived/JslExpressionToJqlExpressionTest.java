...
public class JslExpressionToJqlExpressionTest extends AbstractTest {
    ...
    void testDerivedExpressionModel() throws Exception {
        ...
        assertEquals("self.value!isDefined() ? (self.value!floor()!isDefined() ? (self.value!floor()!abs()) : (5!abs())) : (9!floor()!isDefined() ? (self.value!floor()!abs()) : (5!abs()))", jqlDerived("Lead", "orElseValue2", "", ""));
